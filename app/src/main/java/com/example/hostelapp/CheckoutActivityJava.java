...
public class CheckoutActivityJava extends AppCompatActivity {
    ...
    //    private static final String BACKEND_URL = "https://hostelapp-stripe-payment.herokuapp.com/";
...
//        amountString = getIntent().getStringExtra("amount");
        ...
        stripe = new Stripe(
                ...
                Objects.requireNonNull("pk_test_51HtvFwENPU63bMqTaMO8F4MfVFJOvzPSzXQByHufdPijU8h4GKq6H4BOFLQhXiFReizHurMPJrsKmmGWeiOy2vKF00g1ZHI4eA")
        );
        startCheckout();
    }
...
//                );
                Toast.makeText(activity, "Transaction Successful", Toast.LENGTH_LONG);
